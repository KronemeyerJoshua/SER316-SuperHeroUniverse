    ...
    static {
        ...
        if (abilities != null) {
            ...
            for (int i = 0; i < abilityArray.length(); i++) {
                ...
                heroAbilitiesBuilder.add(new Ability(ability.getInt("damage"),
                        ability.getString("description"), ability.getString("name")));
            }
            ...
            for (int i = 0; i < abilityArray.length(); i++) {
                JSONObject ability = abilityArray.getJSONObject(i);
                villainAbilitiesBuilder.add(new Ability(ability.getInt("damage"),
                        ability.getString("description"), ability.getString("name")));
            }
